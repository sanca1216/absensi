...
<html>
    ...
    <body style="background:#586df5;">
        <div class="container">
            ...
            <br/><br/>
            <h4 style="color:white;">Data Dosen</h4>
            <a href="tambah.php" class="btn btn-success btn-md mb-3"><span class="fa fa-plus"></span> Tambah Dosen</a>
            <div class="card">
                <div class="card-header"><h5>Daftar Dosen</h5></div>
                <div class="card-body">
                    <table class="table table-hover table-bordered" id="mytable">
                        ...
                        <tbody>
                            <?php
                                $no=1;
                                $hasil = $proses->tampil_data_query("SELECT * FROM tbl_user WHERE role='dosen'");
